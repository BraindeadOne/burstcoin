    ...
    static void init() {
        try (Connection con = Db.beginTransaction(); Statement stmt = con.createStatement()) {
            ...
            try {
                ...
                logger.info("Initializing an empty database", e);
            ...
            switch (nextUpdate) {
                case 1:
                    apply("CREATE TABLE alias("
                            + "    db_id BIGINT NOT NULL GENERATED BY DEFAULT AS IDENTITY,"
                            + "    id BIGINT NOT NULL,"
        ...
        //             apply("CREATE TRIGGER lower_alias_name_insert BEFORE INSERT ON alias FOR EACH ROW SET NEW.alias_name_lower = LOWER(NEW.alias_name);");
                ...
                case 7:
                    apply("CREATE TABLE account("
                            ...
                            + "    public_key VARCHAR(32) FOR BIT DATA ,"
                            + "    key_height INT,"
                ...
                case 12:
                    apply("CREATE TABLE peer("
                            ...
                            + ")");
                case 13:
                    apply("CREATE TABLE txn ("
                            + "    db_id BIGINT  NOT NULL GENERATED BY DEFAULT AS IDENTITY,"
                            + "    id BIGINT NOT NULL,"
                            + "    deadline SMALLINT NOT NULL,"
                            + "    sender_public_key VARCHAR(32) FOR BIT DATA  NOT NULL,"
                            + "    recipient_id BIGINT,"
                            + "    amount BIGINT NOT NULL,"
                            + "    fee BIGINT NOT NULL,"
                            + "    height INT NOT NULL,"
                            + "    block_id BIGINT NOT NULL,"
                            + "    signature VARCHAR(64) FOR BIT DATA ,"
                            + "    timestamp INT NOT NULL,"
                            + "    type SMALLINT NOT NULL,"
                            + "    subtype SMALLINT NOT NULL,"
                            + "    sender_id BIGINT NOT NULL,"
                            + "    block_timestamp INT NOT NULL,"
                            + "    full_hash VARCHAR(32) FOR BIT DATA  NOT NULL,"
                            + "    referenced_transaction_full_hash VARCHAR(32) FOR BIT DATA ,"
                            ...
                            + ")");
                case 14:
                    apply("CREATE INDEX transaction_block_timestamp_idx ON txn (block_timestamp)");
                case 15:
                    apply("CREATE UNIQUE INDEX transaction_id_idx ON txn (id)");
                case 16:
                    apply("CREATE INDEX transaction_sender_id_idx ON txn (sender_ID)");
                case 17:
                    apply("CREATE UNIQUE INDEX transaction_full_hash_idx ON txn (full_hash)");
                case 18:
                     apply("CREATE INDEX transaction_recipient_id_idx ON txn (recipient_id)");
                case 19:
                    apply("CREATE INDEX transaction_recipient_id_amount_height_idx ON txn (recipient_id, amount, height)");
                case 20:
                ...
                case 42:
                    apply("CREATE TABLE purchase("
                            ...
                            + "    note BLOB,"
                            + "    nonce VARCHAR(32) FOR BIT DATA ,"
                            + "    timestamp INT NOT NULL,"
                            + "    pending BOOLEAN NOT NULL,"
                            + "    goods BLOB,"
                            + "    goods_nonce VARCHAR(32) FOR BIT DATA ,"
                            + "    refund_note BLOB,"
                            + "    refund_nonce VARCHAR(32) FOR BIT DATA ,"
                ...
                case 51:
                    apply("CREATE TABLE purchase_feedback("
                            ...
                            + "    feedback_nonce VARCHAR(32) FOR BIT DATA  NOT NULL,"
                            + "    height INT NOT NULL,"
                            + "    latest BOOLEAN DEFAULT TRUE NOT NULL,"
                            + "    PRIMARY KEY (db_id)"
                            + ");");
                ...
                case 79:
                    apply("CREATE TABLE atxn("
                            ...
                            + ");");
                case 80:
                    apply("CREATE UNIQUE INDEX at_id_height_idx ON atxn (id, height DESC);");
                case 81:
                    apply("CREATE INDEX at_creator_id_height_idx ON atxn (creator_id, height DESC);");
                case 82:
                ...
                case 85:
                    apply("CREATE TABLE block("
                            ...
                            + "    generator_public_key VARCHAR(32) FOR BIT DATA  NOT NULL,"
                            + "    previous_block_hash VARCHAR(32) FOR BIT DATA ,"
                            + "    cumulative_difficulty BLOB NOT NULL,"
                            + "    base_target BIGINT NOT NULL,"
                            + "    next_block_id BIGINT,"
                            + "    height INT NOT NULL,"
                            + "    generation_signature VARCHAR(64) FOR BIT DATA  NOT NULL,"
                            + "    block_signature VARCHAR(64) FOR BIT DATA  NOT NULL,"
                            + "    payload_hash VARCHAR(32) FOR BIT DATA  NOT NULL,"
                ...
                case 90:
//                    apply("ALTER TABLE txn ADD CONSTRAINT constraint_ff FOREIGN KEY(block_id) REFERENCES block(block_id_idx) ON DELETE CASCADE;");
                case 91:
...
//                    apply("ALTER TABLE goods CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;");
                case 169:
//                    apply("ALTER TABLE atxn CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;");
                case 170:
                    return;
                default:
